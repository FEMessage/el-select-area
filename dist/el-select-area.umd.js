(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('babel-runtime/helpers/defineProperty'), require('lodash.find')) :
  typeof define === 'function' && define.amd ? define(['exports', 'babel-runtime/helpers/defineProperty', 'lodash.find'], factory) :
  (factory((global.ElSelectArea = {}),global._defineProperty,global.find));
}(this, (function (exports,_defineProperty,find) { 'use strict';
  ...
  (function () {
    if (typeof document !== 'undefined') {
      var head = document.head || document.getElementsByTagName('head')[0],
          ...
          css = " .el-select-area { font-size: 0; } .el-select-area .select-area-item { margin-right: 10px; vertical-align: middle; } ";style.type = 'text/css';if (style.styleSheet) {
  ...
  var Component = { render: function render() {
    ...
    watch: {
      ...
      curCountyCode: function curCountyCode(val, oldVal) {
    ...
    methods: {
      provinceChange: function provinceChange(val) {
        ...
        if (this.level === 0) {
          ...
          if (this.defaults[1]) {
            if (this.isCode) {
              curCityCode = find(Object.keys(this.citys), function (item) {
                return item === _this2.defaults[1];
              });
              assert(curCityCode, '\u57CE\u5E02 ' + this.defaults[1] + ' \u4E0D\u5B58\u5728\u4E8E\u7701\u4EFD ' + this.defaults[0] + ' \u4E2D');
              curCity = this.citys[curCityCode];
            } else {
              curCity = find(this.citys, function (item) {
                return item === _this2.defaults[1];
              });
              assert(curCity, '\u57CE\u5E02 ' + this.defaults[1] + ' \u4E0D\u5B58\u5728\u4E8E\u7701\u4EFD ' + this.defaults[0] + ' \u4E2D');
              curCityCode = find(Object.keys(this.citys), function (item) {
                return _this2.citys[item] === _this2.defaults[1];
              });
            }
          }
      ...
      cityChange: function cityChange(val) {
        ...
        if (this.level === 1) {
          ...
          if (!this.countys) {
            this.countys = _defineProperty({}, this.curCityCode, this.curCity);
            this.curCounty = this.curCity;
            this.curCountyCode = this.curCityCode;
            return;
          }

          var curCounty = Object.values(this.countys)[0];
          var curCountyCode = Object.keys(this.countys)[0];

          if (this.defaults[2]) {
            if (this.isCode) {
              curCountyCode = find(Object.keys(this.countys), function (item) {
                return item === _this3.defaults[2];
              });
              assert(curCountyCode, '\u53BF\u533A ' + this.defaults[2] + ' \u4E0D\u5B58\u5728\u4E8E\u57CE\u5E02 ' + this.defaults[1] + ' \u4E2D');
              curCounty = this.countys[curCountyCode];
            } else {
              curCounty = find(this.countys, function (item) {
                return item === _this3.defaults[2];
              });
              assert(curCounty, '\u53BF\u533A ' + this.defaults[2] + ' \u4E0D\u5B58\u5728\u4E8E\u57CE\u5E02 ' + this.defaults[1] + ' \u4E2D');
              curCountyCode = find(Object.keys(this.countys), function (item) {
                return _this3.countys[item] === _this3.defaults[2];
              });
            }
          }
      ...
      getAreaCode: function getAreaCode() {
        ...
        switch (this.level) {
          case 0:
            ...
            break;
          case 1:
            codes = [this.curProvinceCode, this.curProvinceCode === TAIWAN_CODE ? this.curProvinceCode : this.curCityCode];
            break;
          case 2:
            codes = [this.curProvinceCode, this.curProvinceCode === TAIWAN_CODE ? this.curProvinceCode : this.curCityCode, this.curCountyCode];
            break;
        }
      ...
      getAreaText: function getAreaText() {
        ...
        switch (this.level) {
          ...
          case 1:
            ...
            break;
          case 2:
            texts = [this.curProvince, this.curProvinceCode === TAIWAN_CODE ? this.curProvince : this.curCity, this.curCounty];
            break;
        }
      ...
      getAreaCodeAndText: function getAreaCodeAndText(selected) {
        ...
        switch (this.level) {
          ...
          case 1:
            ...
            break;
          case 2:
            var cityCode = this.curProvinceCode === TAIWAN_CODE ? this.curProvinceCode : this.curCityCode;
            var cityText = this.curProvinceCode === TAIWAN_CODE ? this.curProvince : this.curCity;
            textCodes = [_defineProperty({}, this.curProvinceCode, this.curProvince), _defineProperty({}, cityCode, cityText), _defineProperty({}, this.curCountyCode, this.curCounty)];
            break;
        }
      ...
      setDefaultValue: function setDefaultValue() {
        ...
        if (this.isCode) {
          ...
          var province = find(this.provinces, function (item) {
            return item === _this4.defaults[0];
          });
          assert(province, '\u7701\u4EFD ' + this.defaults[0] + ' \u4E0D\u5B58\u5728');
          provinceCode = find(Object.keys(this.provinces), function (item) {
